...
namespace Squish.UI.MVC.Controllers
{
    public class StatusController : Controller
    {
        ...
        public StatusController(SQUISHContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("InStock,OutofStock,StatusId")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InStock,OutofStock,StatusId")] Status status)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SQUISHContext.Statuses'  is null.");
            }
            var status = await _context.Statuses.FindAsync(id);
            if (status != null)
            {
